...
Online:
Mit dem Service "`ShareLatex"' (\url{https://www.sharelatex.com/}) gab es positive Erfahrungen. Damit können die Dokument online erstellt und gemeinsam verwendet werden.
